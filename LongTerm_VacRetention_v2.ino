...
Long term Vac Retention Fixture v2.0
 - LED indication for Gauge Pressure ranges (Different colors for different ranges)
...
#define SDSS  4
#define SAVE_INTERVAL 10000 //save to SD every 2s //Modify this for data capture rates (2000 - 2s)
